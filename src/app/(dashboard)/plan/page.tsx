...
import { TaskTemplateList } from '@/components/templates/TaskTemplateList';

export default function PlanPage() {
  const [activeTab, setActiveTab] = useState<'goals' | 'monthly' | 'weekly' | 'templates'>('goals');
  ...
  return (
    <div className="p-4 md:p-6 max-w-4xl mx-auto">
      ...
      <div className="flex gap-2 mb-6 bg-muted/50 rounded-lg p-1 inline-flex flex-wrap">
        <button
